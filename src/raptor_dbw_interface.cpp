...

{
  ...
  double steering_tier_angle = msg->lateral.steering_tire_angle;
  ...
  misc_cmd_.rolling_counter = counter_;
  ...
  steer_cmd.angle_cmd = steering_tier_angle * steering_ratio_;  
